...
| codex | 100.0% (3/3) | 0 | 43.8%-100.0% | 94.4% | 0 | 0 | 57.8s | 83.5s | 85.8s | $1.00 | $3.00 | 0.827 | none |
...
- Added focused layer1 regression tests proving canonical policy headings pass, shorthand-only echoes fail, and the fixture creates the monorepo signal.
...
| codex | 3 | 94.4% | 0 | 0 | workflow-artifact-reference 0.0%; workflow-actionability 83.3%; workflow-fixture-facts 100.0%; workflow-output-includes-an-orchestration-policy-section 100.0%; workflow-output-includes-a-monorepo-safety-policy-section 100.0% |
...
- Codex: `tests/benchmarks/runs/provision-agentic-config-codex-1ef8828f/`

## Recommendation

The benchmark fixture false negative is fixed. Both agents now pass 3/3 on the corrected fixture.
